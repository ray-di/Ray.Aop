<?php
require __DIR__ . '/src/Ray/Aop/Annotation.php';
require __DIR__ . '/src/Ray/Aop/Advice.php';
require __DIR__ . '/src/Ray/Aop/Joinpoint.php';
require __DIR__ . '/src/Ray/Aop/Interceptor.php';
require __DIR__ . '/src/Ray/Aop/MethodInterceptor.php';
