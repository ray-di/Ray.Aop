...
### Fixed
- Weaved class files are written atomically again (tempnam + rename). Concurrent processes sharing a script dir could `require` a half-written file and fail with `Class not found` or `CompilationFailedException`. Regression of #137 since 2.15.0. (#266)
